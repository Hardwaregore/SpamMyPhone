...
export interface PubSubClientApiEvents extends PubSubNamespace.BasePubSubApiEvents {
}
export interface ClientFullState extends PubSubClient {
}
interface PubSubClient extends PubSubContract, Omit<ConsumerContract<PubSubClientApiEvents, ClientFullState>, 'subscribe'> {
